...
import { ThumbsUp, ThumbsDown, Star, Mail, Calendar, User, Building2, TrendingUp, Filter, Search } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <button
                ...
                className={`p-2 rounded-lg border transition-colors ${
                  selectedEmail.feedback === 'positive'
                    ...
                    : 'border-gray-300 text-gray-400 hover:text-green-600 hover:border-green-500'
                }`}
              >
              ...
              <button
                ...
                className={`p-2 rounded-lg border transition-colors ${
                  selectedEmail.feedback === 'negative'
                    ...
                    : 'border-gray-300 text-gray-400 hover:text-red-600 hover:border-red-500'
                }`}
              >
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="text-sm font-medium text-gray-900">{selectedEmail.subject}</div>
              </div>
              <div>
                <div className="text-xs text-gray-500 mb-1">Body:</div>
                <div className="text-sm text-gray-700 whitespace-pre-wrap">{selectedEmail.body}</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-xs font-semibold text-gray-700 mb-2">Strengths:</h4>
              ...
              <div>
                <h4 className="text-xs font-semibold text-gray-700 mb-2">Areas for Improvement:</h4>
                <ul className="space-y-1">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-blue-200">
                <div>
                  <h4 className="text-xs font-semibold text-gray-700 mb-1">Tone:</h4>
                  <p className="text-sm text-gray-700">{selectedEmail.aiAnalysis.tone}</p>
                </div>
                <div>
                  <h4 className="text-xs font-semibold text-gray-700 mb-1">Readability:</h4>
                  <p className="text-sm text-gray-700">{selectedEmail.aiAnalysis.readability}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {filteredEmails.map((email) => (
          <div
            ...
            className="bg-white rounded-lg border border-gray-200 p-6 hover:border-ibm-blue hover:shadow-md transition-all cursor-pointer"
          >
